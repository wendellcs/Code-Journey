...
export const Banner = () => {
    return (
        <section className="text-center flex justify-center flex-col overflow-hidden aurora-container h-175 relative bg-[radial-gradient(61.31%_274.2%_at_20.24%_87.15%,rgba(100,46,136,0.1)_0%,rgba(102,102,102,0)_100%)]" >
            <Aurora type={'two'} className={'top-0 left-0 animate-float-left'} />

            <div className="relative z-10 flex gap-10 flex-col">
